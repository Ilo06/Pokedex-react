...
export const Footer = () => {
	...
	return (
		<footer className="bg-gradient-to-br from-[#1e3c72] to-[#2a5298] text-white mt-auto relative overflow-hidden px-6 py-12">
			...
			<div className="max-w-screen-xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 z-10 relative">
				<div className="hover:-translate-y-1 transition-transform">
					<h3 className="text-xl font-bold mb-4 bg-gradient-to-r from-yellow-300 to-yellow-100 text-transparent bg-clip-text shadow-sm relative overflow-hidden after:absolute after:top-0 after:left-[-100%] after:w-full after:h-full after:bg-gradient-to-r after:from-transparent after:via-white/20 after:to-transparent after:animate-shine">
						PokéAPI Explorer
					</h3>
					<p className="text-gray-200 leading-relaxed">
						Découvrez le monde fascinant des Pokémon avec notre application interactive.
					</p>
				</div>

				<div className="hover:-translate-y-1 transition-transform">
					<h4 className="text-lg font-semibold text-yellow-300 mb-4">Liens utiles</h4>
					<ul className="space-y-2 text-sm text-gray-200">
						...
						<li>
							<a href="https://www.pokemon.com/" target="_blank" rel="noopener noreferrer" className="hover:text-yellow-300 transition-all">▶ Site officiel Pokémon</a>
						</li>
						<li>
				...
				<div className="hover:-translate-y-1 transition-transform">
					<h4 className="text-lg font-semibold text-yellow-300 mb-4">Fonctionnalités</h4>
					<ul className="space-y-2 text-sm italic text-gray-200">
						<li>Recherche de Pokémon</li>
			...
			<div className="mt-10 border-t border-white/30 pt-6 text-center text-sm text-gray-400">
				<p>© {currentYear} PokéAPI Explorer. Tous droits réservés.</p>
			</div>
		</footer>
	);
};
